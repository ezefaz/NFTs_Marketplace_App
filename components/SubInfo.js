...
export const EndDate = () => {
  return (
    ...
    maxWidth: '50%'
      ...
      <Text style={{ fontFamily: FONTS.regular, fontSize: FONTS.small, color: COLORS.primary }}>Ending In</Text>
      <Text style={{ fontFamily: FONTS.semiBold, fontSize: FONTS.medium, color: COLORS.primary }}>12h 30m</Text>
    </View>
  )
}
